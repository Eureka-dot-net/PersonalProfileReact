...
{
    /// <inheritdoc />
    public partial class ConvertToSqlLite : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName_En = table.Column<string>(type: "TEXT", nullable: false),
                    FullName_He = table.Column<string>(type: "TEXT", nullable: false),
                    Bio_En = table.Column<string>(type: "TEXT", nullable: false),
                    Bio_He = table.Column<string>(type: "TEXT", nullable: false),
                    Location_En = table.Column<string>(type: "TEXT", nullable: false),
                    Location_He = table.Column<string>(type: "TEXT", nullable: false),
